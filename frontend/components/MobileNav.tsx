...
import { LayoutGrid, Cpu, Container, ArrowDownUp, Film, FolderOpen, Sparkles } from 'lucide-react'
  ...
  return (
    <nav className="mobile-nav">
      {items.map(({ href, label, Icon }) => (
        ...
        >
          <span className="mobile-nav-icon"><Icon size={20} strokeWidth={1.8} /></span>
          {label}
        </Link>
      ))}
    </nav>
